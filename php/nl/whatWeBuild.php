...
<body>
    ...
    <footer class="cta" role="contentinfo">
        ...
        <a class="cta-primary" href="../../php/nl/dots.php">Bekijk D.O.T.S</a>
        <a class="cta-primary" href="../../php/nl/blogs.php">Onze Blog</a>
        <a class="cta-primary" href="../../php/nl/miniQuiz.php">Doe de Quiz</a>
        <a class="cta-primary" href="../../php/nl/contactPage.php">Start je project</a>
    </footer>
